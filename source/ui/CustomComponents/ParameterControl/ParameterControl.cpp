...
void ParameterControl::resized() {
    ...
    fadeSlider.setBounds(width * 105 / 560, height * 50 / 660, width * 120 / 560, height * 500 / 660);
    dynamicSlider.setBounds(width * 255 / 560, height * 95 / 660, width * 120 / 560, height * 500 / 660);
    mixSlider.setBounds(width * 405 / 560, height * 40 / 660, width * 120 / 560, height * 500 / 660);
}
